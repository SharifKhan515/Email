...
<div id="mb7zbsebul_wrapper" style="max-width: 184px;">
  ...
  <li><div class="buttonbg gradient_button gradient34"><a href="logout.php">Sign-Out</a></div></li>
...
$query="SELECT `from`, `sub`, `body`, `time`, `date` FROM `email_body` WHERE `to-id`='$id' ORDER BY  `email_body`.`times` DESC";
if($query_run = mysql_query($query))
{
		...
		while($query_row=mysql_fetch_assoc($query_run))
	{
		...
		echo "<table CELLSPACING=\"1\" CELLPADDING=\"5\" WIDTH=\"100%\" BORDER=\"1\">
           ...
           <td width=\"30%\">$from</td>
            <td width=\"40%\"><form action=\"mailread.php\" method=\"get\">
